...
main() {
    ...
    case "$target" in
        ...
        *)
            ...
            echo "Available: all deps syntax config helpers jq cm sb proxylink nft nftv6 selmark isolation monfd unsupported textlist chunkcheck diagnostics subscription fastest insecure rejected jobstate selfheal dnsdetour suburlopt globalproxy stablecheck extcheck netshiftcheck latesttag ghredirect selfupdate backupguard hotreload"
            exit 1
            ;;
    esac
